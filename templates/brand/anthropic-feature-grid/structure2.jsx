...
/**
 * Anthropic feature-card grid (dark-navy variation).
 * Maps to DESIGN.md `product-mockup-card-dark`:
 *   background = surface-dark (#181715), rounded 12px, padding 32px.
 * Cards sit on surface-dark-elevated (#252320); coral accent rules.
 * The dark surface IS the elevation signal — no shadows.
 */
export default function AnthropicFeatureGridDark({ content, style }) {
          ...
          return (
            <div
              ...
              style={{
                ...
                background: palette.primary ?? "#252320",
                color: palette.foreground ?? "#faf9f5",
                borderRadius: 12,
                padding: 32,
                display: "flex",
            ...
            >
              ...
              {c.body && (
                <p style={{ fontSize: 22, lineHeight: 1.5, margin: 0, color: palette.muted ?? "#a09d96" }}>
                  {c.body}
                </p>
              )}
            </div>
