...
/**
 * Anthropic pull-quote (cream-canvas editorial variation).
 * Maps to DESIGN.md's editorial voice: cream canvas, serif quote at
 * display-md (Copernicus substitute), coral accent rule above, author
 * attribution in caption-uppercase (StyreneB/Inter, tracked, uppercase).
 */
export default function AnthropicQuoteCream({ content, style }) {
